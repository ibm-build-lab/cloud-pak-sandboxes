...
CLOUD_PAK_REPO_LOCATION_MCM="https://github.com/ibm-build-lab/cloud-pak-sandboxes/tree/main/terraform/cp4mcm"
...
CLOUD_PAK_REPO_LOCATION_DATA4="https://github.com/ibm-build-lab/cloud-pak-sandboxes/tree/main/terraform/cp4data_4.0"
...
CLOUD_PAK_REPO_LOCATION_DATA="https://github.com/ibm-build-lab/cloud-pak-sandboxes/tree/main/terraform/cp4data_3.5"
...
CLOUD_PAK_REPO_LOCATION_INTEGRATION="https://github.com/ibm-build-lab/cloud-pak-sandboxes/tree/main/terraform/cp4i"
...
CLOUD_PAK_REPO_LOCATION_SECURITY="https://github.com/ibm-build-lab/cloud-pak-sandboxes/tree/main/terraform/cp4s"
...
CLOUD_PAK_REPO_LOCATION_NETWORK_AUTOMATION="https://github.com/ibm-build-lab/cloud-pak-sandboxes/tree/main/terraform/cp4na"

IAF="false"
IAF_VERSION="IBM Automation Foundation 1.0"
IAF_TEMPLATE=./templates/iaf-workspace-configuration.json
IAF_REPO_LOCATION="https://github.com/ibm-build-lab/cloud-pak-sandboxes/tree/main/terraform/iaf"
...
CLOUD_PAK_REPO_LOCATION_AIOPS="https://github.com/ibm-build-lab/cloud-pak-sandboxes/tree/main/terraform/cp4aiops"

ROKS="false"
ROKS_VERSION="Red Hat OpenShift on IBM Cloud"
ROKS_TEMPLATE=./templates/roks-workspace-configuration.json
ROKS_LOCATION="https://github.com/ibm-build-lab/cloud-pak-sandboxes/tree/main/terraform/roks_with_portworx"
...
get_ibm_api_key() {
    ...
    read -s -p "${green}https://github.com/ibm-build-lab/cloud-pak-sandboxes/tree/main/terraform#create-an-ibm-cloud-api-key${bold}:${normal} " -e IBM_API_KEY
    echo " "
    cp workspace-configuration.json temp.json
