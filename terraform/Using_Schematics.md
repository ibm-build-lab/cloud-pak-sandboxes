...
4. Once workspace is created, add **https://github.com/ibm-build-lab/cloud-pak-sandboxes/terraform/cp4data** as the github URL, note `cp4data` is an example.  Change this to whichever module you want to install
