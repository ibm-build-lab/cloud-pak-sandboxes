...
# Namespace
kubectl get namespaces $(terraform output cp4na_namespace)

# All resources
kubectl get all --namespace $(terraform output cp4na_namespace)
```

Using the following credentials:

```bash
terraform output cp4na_user
terraform output cp4na_password
```

Open the following URL:

```bash
open $(terraform output cp4na_endpoint)
```
