...
This Cloud Pak requires an [IBM Cloud API key](https://github.com/ibm-build-lab/cloud-pak-sandboxes/tree/main/terraform#create-an-ibm-cloud-api-key) and an [Entitlement Key](https://myibm.ibm.com/products-services/containerlibrary)
